/**
 * Alias fonte dell'istanza storica `rassegnai` (spec 014). Fonti e
 * categorie sono EMERGENTI (costituzione §2): qui solo le
 * normalizzazioni minime curate sul corpus di rassegnai — gli
 * aggregatori del pattern "via" e gli alias per grafie doppie della
 * stessa testata.
 */
